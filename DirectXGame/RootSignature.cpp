...
void RootSignature::Create() {
	...
	rootParameters[0].DescriptorTable.NumDescriptorRanges = _countof(srvDescRange); // Rangeは1個
	...
	staticSamplers[0].MaxLOD = D3D12_FLOAT32_MAX;// あったけのMipMapを使う
	staticSamplers[0].ShaderRegister = 0;// レジスタ番号を使う(s0)
	...
	HRESULT hr = D3D12SerializeRootSignature(&descriptionRootSignature, D3D_ROOT_SIGNATURE_VERSION_1_0, &signatureBlob, &errorBlob);
